...
class Test_API:
    ...
    def test_create_task(self, driver):
        ...
        create_task_response = create_task(payload, URL)
        ...
        get_task_response = get_task(task_id, URL)
    ...
    def test_update_task(self, driver):
        ...
        update_task_response = update_task(new_payload, URL)
    ...
    def test_list_tasks(self, driver):
        ...
        for i in range(count):
            ...
            assert create_task_response.status_code == 200, \
                f"Error: status code is not correct. Expected: 200, Actual: {create_task_response.status_code}"
        user_id = payload["user_id"]
        list_task_response = list_tasks(user_id, URL)
    ...
    def test_delete_task(self, driver):
        ...
        assert create_task_response.status_code == 200, \
            f"Error: status code is not correct. Expected: 200, Actual: {create_task_response.status_code}"
        task_id = create_task_response.json()["task"]["task_id"]
        delete_task_response = delete_task(task_id, URL)
